...
e = this, n = () => (() => {
            ...
            692: function(e, n) {
                ...
                i = "undefined" != typeof window ? window : this, o = function(i, o) {
                    ...
                    function b(e, n, t) {
                        ...
                        if (r.text = e, n)
                            for (i in w)(o = n[i] || n.getAttribute && n.getAttribute(i)) && r.setAttribute(i, o);
                    ...
                    T.fn = T.prototype = {
                        ...
                        var e, n, t, i, o, r, a = arguments[0] || {},
                            s = 1,
                            l = arguments.length,
                            c = !1;
                        for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || m(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
                            if (null != (e = arguments[s]))
                                for (n in e) i = e[n], "__proto__" !== n && a !== i && (c && i && (T.isPlainObject(i) || (o = Array.isArray(i))) ? (t = a[n], r = o && !Array.isArray(t) ? [] : o || T.isPlainObject(t) ? t : {}, o = !1, a[n] = T.extend(c, r, i)) : void 0 !== i && (a[n] = i));
                        return a
                    }, T.extend({
                        ...
                        each: function(e, n) {
                            var t, i = 0;
                            if (D(e))
                                for (t = e.length; i < t && !1 !== n.call(e[i], i, e[i]); i++);
                            else
                                for (i in e)
                        ...
                        map: function(e, n, t) {
                            var i, o, r = 0,
                                a = [];
                            if (D(e))
                                for (i = e.length; r < i; r++) null != (o = n(e[r], r, t)) && a.push(o);
                            else
                                for (r in e) null != (o = n(e[r], r, t)) && a.push(o);
                            return l(a)
                        },
                        guid: 1,
                        support: v
                    ...
                    ! function() {
                        ...
                        function K(e, n, t, i) {
                            var o, r, a, s, c, u, g, f = n && n.ownerDocument,
                                y = n ? n.nodeType : 9;
                            ...
                            return i != l && 9 === i.nodeType && i.documentElement ? (c = (l = i).documentElement, d = !T.isXMLDoc(l), f = c.matches || c.webkitMatchesSelector || c.msMatchesSelector, c.msMatchesSelector && O != l && (t = l.defaultView) && t.top !== t && t.addEventListener("unload", Q), v.getById = te(function(e) {
                                ...
                                if (void 0 !== n.getElementById && d) {
                                    ...
                                    if (r) {
                                        ...
                                        for (o = n.getElementsByName(e), i = 0; r = o[i++];)
                                            if ((t = r.getAttributeNode("id")) && t.value === e) return [r]
                                    }
                                    return []
                                }
                        ...
                        for (e in K.matches = function(e, n) {
                                ...
                                var i = n.attrHandle[t.toLowerCase()],
                                    o = i && g.call(n.attrHandle, t.toLowerCase()) ? i(e, t, !d) : void 0;
                                ...
                                filter: {
                                    ...
                                    CHILD: function(e, n, t, i, o) {
                                        ...
                                        return 1 === i && 0 === o ? function(e) {
                                            ...
                                            var c, u, d, p, g, f = r !== a ? "nextSibling" : "previousSibling",
                                                h = n.parentNode,
                                                v = s && n.nodeName.toLowerCase(),
                                                x = !l && !s,
                                                w = !1;
                                            if (h) {
                                                if (r) {
                                                    for (; f;) {
                                                        for (d = n; d = d[f];)
                                                            if (s ? L(d, v) : 1 === d.nodeType) return !1;
                                                        g = f = "only" === e && !g && "nextSibling"
                                                    }
                                                    return !0
                                                }
                                                if (g = [a ? h.firstChild : h.lastChild], a && x) {
                                                    for (w = (p = (c = (u = h[m] || (h[m] = {}))[e] || [])[0] === y && c[1]) && c[2], d = p && h.childNodes[p]; d = ++p && d && d[f] || (w = p = 0) || g.pop();)
                                                        if (1 === d.nodeType && ++w && d === n) {
                                                            u[e] = [y, p, w];
                                                            break
                                                        }
                                                } else if (x && (w = p = (c = (u = n[m] || (n[m] = {}))[e] || [])[0] === y && c[1]), !1 === w)
                                                    for (;
                                                        (d = ++p && d && d[f] || (w = p = 0) || g.pop()) && (!(s ? L(d, v) : 1 === d.nodeType) || !++w || (x && ((u = d[m] || (d[m] = {}))[e] = [y, w]), d !== n)););
                                    ...
                                    PSEUDO: function(e, t) {
                                        ...
                                        return o[m] ? o(t) : o.length > 1 ? (i = [e, e, "", t], n.setFilters.hasOwnProperty(e.toLowerCase()) ? ne(function(e, n) {
                                ...
                                pseudos: {
                                    ...
                                    contains: ne(function(e) {
                                        return e = e.replace(Y, Z),
                                            function(n) {
                                                return (n.textContent || T.text(n)).indexOf(e) > -1
                                            }
                                    }),
                                    lang: ne(function(e) {
                                        return _.test(e || "") || K.error("unsupported lang: " + e), e = e.replace(Y, Z).toLowerCase(),
                                            function(n) {
                                                var t;
                                                do {
                        ...
                        function pe(e, n, t) {
                            ...
                            return n.first ? function(n, t, o) {
                                for (; n = n[i];)
                                    if (1 === n.nodeType || a) return e(n, t, o);
                                return !1
                            } : function(n, t, l) {
                                var c, u, d = [y, s];
                                if (l) {
                        ...
                        function he(e, n, t, i, o, r) {
                            return i && !i[m] && (i = he(i)), o && !o[m] && (o = he(o, r)), ne(function(r, a, s, l) {
                                var c, d, p, g, f = [],
                                    ...
                                    x = !e || !r && n ? y : fe(y, f, e, s, l);
                                if (t ? t(x, g = o || (r ? e : m || i) ? [] : a, s, l) : g = x, i)
                                    for (c = fe(g, v), i(c, [], s, l), d = c.length; d--;)(p = c[d]) && (g[v[d]] = !(x[v[d]] = p));
                                if (r) {
                                    if (o || e) {
                                        if (o) {
                        ...
                        function ve(e) {
                            for (var i, o, r, a = e.length, s = n.relative[e[0].type], l = s || n.relative[" "], c = s ? 1 : 0, d = pe(function(e) {
                                    ...
                                    return u.call(i, e) > -1
                                }, l, !0), g = [function(e, n, o) {
                                    var r = !s && (o || n != t) || ((i = n).nodeType ? d(e, n, o) : p(e, n, o));
                                    return i = null, r
                                }]; c < a; c++)
                                if (o = n.relative[e[c].type]) g = [pe(ge(g), o)];
                                else {
                                    ...
                                    var o = i.length > 0,
                                        ...
                                        a = function(a, s, c, u, p) {
                                            ...
                                            for (p && (t = s == l || s || p); x !== D && null != (g = C[x]); x++) {
                                                if (r && g) {
                                                    for (f = 0, s || g.ownerDocument == l || (le(g), c = !d); v = e[f++];)
                                                        if (v(g, s || l, c)) {
                                                            h.call(u, g);
                                                            break
                                                        } p && (y = S)
                        ...
                        function ye(e, t, i, o) {
                            ...
                            if (i = i || [], 1 === p.length) {
                                ...
                                for (r = F.needsContext.test(e) ? 0 : a.length; r-- && (s = a[r], !n.relative[l = s.type]);)
                                    if ((c = n.find[l]) && (o = c(s.matches[0].replace(Y, Z), X.test(a[0].type) && se(t.parentNode) || t))) {
                    ...
                    T.filter = function(e, n, t) {
                        var i = n[0];
                        return t && (e = ":not(" + e + ")"), 1 === n.length && 1 === i.nodeType ? T.find.matchesSelector(i, e) ? [i] : [] : T.find.matches(e, T.grep(n, function(e) {
                            return 1 === e.nodeType
                        }))
                    }, T.fn.extend({
                        find: function(e) {
                    ...
                    (T.fn.init = function(e, n, t) {
                        ...
                        if (t = t || R, "string" == typeof e) {
                            if (!(i = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : _.exec(e)) || !i[1] && n) return !n || n.jquery ? (n || t).find(e) : this.constructor(n).find(e);
                            if (i[1]) {
                                if (n = n instanceof T ? n[0] : n, T.merge(this, T.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : x, !0)), P.test(i[1]) && T.isPlainObject(n))
                                    for (i in n) m(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
                                return this
                            }
                            ...
                            if (!$.test(e))
                                for (; i < o; i++)
                                    for (t = this[i]; t && t !== n; t = t.parentNode)
                                        if (t.nodeType < 11 && (a ? a.index(t) > -1 : 1 === t.nodeType && T.find.matchesSelector(t, e))) {
                                            r.push(t);
                                            break
                    ...
                    function Z(e, n, t, i) {
                        var o;
                        try {
                            e && m(o = e.promise) ? o.call(e).done(n).fail(t) : e && m(o = e.then) ? o.call(e, n, t) : n.apply(void 0, [e].slice(i))
                        } catch (e) {
                            t.apply(void 0, [e])
                        }
                    }
                    T.Callbacks = function(e) {
                        ...
                        var n, t, i, o, r = [],
                            ...
                            s = -1,
                            l = function() {
                                for (o = o || e.once, i = n = !0; a.length; s = -1)
                                    for (t = a.shift(); ++s < r.length;) !1 === r[s].apply(t[0], t[1]) && e.stopOnFalse && (s = r.length, t = !1);
                            ...
                            c = {
                                ...
                                remove: function() {
                                    return T.each(arguments, function(e, n) {
                                        for (var t;
                                            (t = T.inArray(n, r, t)) > -1;) r.splice(t, 1), t <= s && s--
                                    }), this
                                },
                                has: function(e) {
                                ...
                                fireWith: function(e, t) {
                                    return o || (t = [e, (t = t || []).slice ? t.slice() : t], a.push(t), n || l()), this
                                },
                                fire: function() {
                                                ...
                                                var s = this,
                                                    ...
                                                    c = function() {
                                                        ...
                                                        if (!(e < r)) {
                                                            ...
                                                            c = i && ("object" == typeof i || "function" == typeof i) && i.then, m(c) ? o ? c.call(i, a(r, n, X, o), a(r, n, Y, o)) : (r++, c.call(i, a(r, n, X, o), a(r, n, Y, o), a(r, n, X, n.notifyWith))) : (t !== X && (s = void 0, l = [i]), (o || n.resolveWith)(s, l))
                                                        }
                                                    },
                                                    u = o ? c : function() {
                                                        try {
                                                            ...
                                                            T.Deferred.exceptionHook && T.Deferred.exceptionHook(i, u.error), e + 1 >= r && (t !== Y && (s = void 0, l = [i]), n.rejectWith(s, l))
                                                        }
                                                    };
                    ...
                    T.fn.ready = function(e) {
                        ...
                        readyWait: 1,
                        ready: function(e) {
                            (!0 === e ? --T.readyWait : T.isReady) || (T.isReady = !0, !0 !== e && --T.readyWait > 0 || J.resolveWith(x, [T]))
                        }
                    ...
                    var ee = function(e, n, t, i, o, r, a) {
                            var s = 0,
                                ...
                                c = null == t;
                            if ("object" === k(t))
                                for (s in o = !0, t) ee(e, n, s, t[s], !0, r, a);
                            else if (void 0 !== i && (o = !0, m(i) || (a = !0), c && (a ? (n.call(e, i), n = null) : (c = n, n = function(e, n, t) {
                                    return c.call(T(e), t)
                                })), n))
                                for (; s < l; s++) n(e[s], t, a ? i : i.call(e[s], s, n(e[s], t)));
                    ...
                    ae.uid = 1, ae.prototype = {
                        ...
                        remove: function(e, n) {
                            ...
                            if (void 0 !== i) {
                                if (void 0 !== n) {
                                    t = (n = Array.isArray(n) ? n.map(oe) : (n = oe(n)) in i ? [n] : n.match(U) || []).length;
                                    for (; t--;) delete i[n[t]]
                    ...
                    function xe(e, n, t, i) {
                        var o, r, a = 20,
                            ...
                            l = s(),
                            c = t && t[3] || (T.cssNumber[n] ? "" : "px"),
                            u = e.nodeType && (T.cssNumber[n] || "px" !== c && +l) && ge.exec(T.css(e, n));
                        if (u && u[3] !== c) {
                    ...
                    function Ee(e, n) {
                        var t;
                        return t = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(n || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(n || "*") : [], void 0 === n || n && L(e, n) ? T.merge([e], t) : t
                    }
                    ...
                    function Ie(e, n, t, i, o) {
                        for (var r, a, s, l, c, u, d = n.createDocumentFragment(), p = [], g = 0, f = e.length; g < f; g++)
                            if ((r = e[g]) || 0 === r)
                                if ("object" === k(r)) T.merge(p, r.nodeType ? [r] : r);
                                else if (je.test(r)) {
                            for (a = a || d.appendChild(n.createElement("div")), s = (De.exec(r) || ["", ""])[1].toLowerCase(), l = Ae[s] || Ae._default, a.innerHTML = l[1] + T.htmlPrefilter(r) + l[2], u = l[0]; u--;) a = a.lastChild;
                        ...
                        for (d.textContent = "", g = 0; r = p[g++];)
                            ...
                            else if (c = ve(r), a = Ee(d.appendChild(r), "script"), c && Me(a), t)
                            for (u = 0; r = a[u++];) Le.test(r.type || "") && t.push(r);
                        return d
                    }
                    var ze = /^([^.]*)(?:\.(.+)|)/;
                    ...
                    T.event = {
                        ...
                        add: function(e, n, t, i, o) {
                            ...
                            if (re(e))
                                for (t.handler && (t = (r = t).handler, o = r.selector), o && T.find.matchesSelector(he, o), t.guid || (t.guid = T.guid++), (l = v.events) || (l = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function(n) {
                                        return void 0 !== T && T.event.triggered !== n.type ? T.event.dispatch.apply(e, arguments) : void 0
                                    }), c = (n = (n || "").match(U) || [""]).length; c--;) g = h = (s = ze.exec(n[c]) || [])[1], f = (s[2] || "").split(".").sort(), g && (d = T.event.special[g] || {}, g = (o ? d.delegateType : d.bindType) || g, d = T.event.special[g] || {}, u = T.extend({
                                    type: g,
                                    origType: h,
                                    data: i,
                                    handler: t,
                        ...
                        remove: function(e, n, t, i, o) {
                            ...
                            if (v && (l = v.events)) {
                                for (c = (n = (n || "").match(U) || [""]).length; c--;)
                                    if (g = h = (s = ze.exec(n[c]) || [])[1], f = (s[2] || "").split(".").sort(), g) {
                                        ...
                                        for (g in l) T.event.remove(e, g + n[c], t, i, !0);
                                T.isEmptyObject(l) && se.remove(e, "handle events")
                            }
                        },
                        dispatch: function(e) {
                            var n, t, i, o, r, a, s = new Array(arguments.length),
                                l = T.event.fix(e),
                                c = (se.get(this, "events") || Object.create(null))[l.type] || [],
                                u = T.event.special[l.type] || {};
                            for (s[0] = l, n = 1; n < arguments.length; n++) s[n] = arguments[n];
                            if (l.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                                for (a = T.event.handlers.call(this, l, c), n = 0;
                                    (o = a[n++]) && !l.isPropagationStopped();)
                                    for (l.currentTarget = o.elem, t = 0;
                                        (r = o.handlers[t++]) && !l.isImmediatePropagationStopped();) l.rnamespace && !1 !== r.namespace && !l.rnamespace.test(r.namespace) || (l.handleObj = r, l.data = r.data, void 0 !== (i = ((T.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, s)) && !1 === (l.result = i) && (l.preventDefault(), l.stopPropagation()));
                            ...
                            if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                                for (; c !== this; c = c.parentNode || this)
                                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                                        for (r = [], a = {}, t = 0; t < l; t++) void 0 === a[o = (i = n[t]).selector + " "] && (a[o] = i.needsContext ? T(o, this).index(c) > -1 : T.find(o, this, null, [c]).length), a[o] && r.push(i);
                                        r.length && s.push({
                                            elem: c,
                                            handlers: r
                                        })
                    ...
                    function Fe(e, n) {
                        ...
                        if (1 === n.nodeType) {
                            if (se.hasData(e) && (s = se.get(e).events))
                                for (o in se.remove(n, "handle events"), s)
                                    for (t = 0, i = s[o].length; t < i; t++) T.event.add(n, o, s[o][t]);
                    ...
                    function We(e, n, t, i) {
                        ...
                        if (p && (r = (o = Ie(n, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
                            ...
                            if (s)
                                for (u = a[a.length - 1].ownerDocument, T.map(a, _e), d = 0; d < s; d++) c = a[d], Le.test(c.type || "") && !se.access(c, "globalEval") && T.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? T._evalUrl && !c.noModule && T._evalUrl(c.src, {
                    ...
                    T.extend({
                        ...
                        clone: function(e, n, t) {
                            ...
                            if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || T.isXMLDoc(e)))
                                for (a = Ee(s), i = 0, o = (r = Ee(e)).length; i < o; i++) Ge(r[i], a[i]);
                            if (n)
                                if (t)
                                    for (r = r || Ee(e), a = a || Ee(s), i = 0, o = r.length; i < o; i++) Fe(r[i], a[i]);
                                else Fe(e, s);
                            return (a = Ee(s, "script")).length > 0 && Me(a, !l && Ee(e, "script")), s
                        },
                        cleanData: function(e) {
                            for (var n, t, i, o = T.event.special, r = 0; void 0 !== (t = e[r]); r++)
                                if (re(t)) {
                                    if (n = t[se.expando]) {
                                        if (n.events)
                                            for (i in n.events) o[i] ? T.event.remove(t, i) : T.removeEvent(t, i, n.handle);
                                        t[se.expando] = void 0
                                    }
                        ...
                        html: function(e) {
                            return ee(this, function(e) {
                                ...
                                if ("string" == typeof e && !Be.test(e) && !Ae[(De.exec(e) || ["", ""])[1].toLowerCase()]) {
                                    e = T.htmlPrefilter(e);
                                    try {
                    ...
                    function en(e, n) {
                        ...
                        var t, o, r, a, s, l, c = x.createElement("div"),
                    ...
                    function dn(e, n, t) {
                        var i = Ze(e),
                            o = (!v.boxSizingReliable() || t) && "border-box" === T.css(e, "boxSizing", !1, i),
                            r = o,
                            a = Ke(e, n, i),
                    ...
                    T.extend({
                        ...
                        T.cssHooks[e + n] = {
                            expand: function(t) {
                                for (var i = 0, o = {}, r = "string" == typeof t ? t.split(" ") : [t]; i < 4; i++) o[e + fe[i] + n] = r[i] || r[i - 2] || r[0];
                                return o
                            }
                    ...
                    function wn(e, n, t) {
                        for (var i, o = (bn.tweeners[n] || []).concat(bn.tweeners["*"]), r = 0, a = o.length; r < a; r++)
                            if (i = o[r].call(t, n, e)) return i
                    }

                    function bn(e, n, t) {
                        var i, o, r = 0,
                            a = bn.prefilters.length,
                            ...
                            l = function() {
                                ...
                                return s.notifyWith(e, [c, i, t]), i < 1 && a ? t : (a || s.notifyWith(e, [c, 1, 0]), s.resolveWith(e, [c]), !1)
                            },
                            c = s.promise({
                                elem: e,
                                props: T.extend({}, n),
                                ...
                                stop: function(n) {
                                    ...
                                    return n ? (s.notifyWith(e, [c, 1, 0]), s.resolveWith(e, [c, n])) : s.rejectWith(e, [c, n]), this
                                }
                            }),
                            u = c.props;
                        for (function(e, n) {
                                var t, i, o, r, a;
                                for (t in e)
                                    if (o = n[i = oe(t)], r = e[t], Array.isArray(r) && (o = r[1], r = e[t] = r[0]), t !== i && (e[i] = r, delete e[t]), (a = T.cssHooks[i]) && "expand" in a)
                                        for (t in r = a.expand(r), delete e[i], r) t in e || (e[t] = r[t], n[t] = o);
                                    else n[i] = o
                            }(u, c.opts.specialEasing); r < a; r++)
                            if (i = bn.prefilters[r].call(c, e, u, c.opts)) return m(i.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
                    ...
                    T.Animation = T.extend(bn, {
                            ...
                            prefilters: [function(e, n, t) {
                                ...
                                for (i in t.queue || (null == (a = T._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function() {
                                    ...
                                    } if ((l = !T.isEmptyObject(n)) || !T.isEmptyObject(g))
                                    for (i in d && 1 === e.nodeType && (t.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = v && v.display) && (c = se.get(e, "display")), "none" === (u = T.css(e, "display")) && (c ? u = c : (ke([e], !0), c = e.style.display || c, u = T.css(e, "display"), ke([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(e, "float") && (l || (p.done(function() {
                                            f.display = c
                                        ...
                                        display: c
                                    }), r && (v.hidden = !h), h && ke([e], !0), p.done(function() {
                                        for (i in h || ke([e]), se.remove(e, "fxshow"), g) T.style(e, i, g[i])
                            ...
                            stop: function(e, n, t) {
                                ...
                                return "string" != typeof e && (t = n, n = e, e = void 0), n && this.queue(e || "fx", []), this.each(function() {
                                    ...
                                    if (o) a[o] && a[o].stop && i(a[o]);
                                        ...
                                        for (o in a) a[o] && a[o].stop && vn.test(o) && i(a[o]);
                    ...
                    T.fn.extend({
                            ...
                            return m(e) ? this.each(function(n) {
                                ...
                                if (i = Ln(this), t = 1 === this.nodeType && " " + Dn(i) + " ") {
                                    for (r = 0; r < n.length; r++)
                                        for (o = n[r]; t.indexOf(" " + o + " ") > -1;) t = t.replace(" " + o + " ", " ");
                                    a = Dn(t), i !== a && this.setAttribute("class", a)
                                }
                            }) : this : this.attr("class", "")
                        },
                        toggleClass: function(e, n) {
                            var t, i, o, r, a = typeof e,
                            ...
                            return m(e) ? this.each(function(t) {
                                ...
                                if (s)
                                    for (r = T(this), o = 0; o < t.length; o++) i = t[o], r.hasClass(i) ? r.removeClass(i) : r.addClass(i);
                        ...
                        hasClass: function(e) {
                            var n, t, i = 0;
                            for (n = " " + e + " "; t = this[i++];)
                                if (1 === t.nodeType && (" " + Dn(Ln(t)) + " ").indexOf(n) > -1) return !0;
                            return !1
                        }
                    });
                    var En = /\r/g;
                    T.fn.extend({
                        ...
                        valHooks: {
                            ...
                            select: {
                                get: function(e) {
                                    var n, t, i, o = e.options,
                                        r = e.selectedIndex,
                                        a = "select-one" === e.type,
                                        s = a ? null : [],
                                        l = a ? r + 1 : o.length;
                                    for (i = r < 0 ? l : a ? r : 0; i < l; i++)
                                        if (((t = o[i]).selected || i === r) && !t.disabled && (!t.parentNode.disabled || !L(t.parentNode, "optgroup"))) {
                    ...
                    T.extend(T.event, {
                        trigger: function(e, n, t, o) {
                            ...
                            if (a = p = s = t = t || x, 3 !== t.nodeType && 8 !== t.nodeType && !zn.test(h + T.event.triggered) && (h.indexOf(".") > -1 && (v = h.split("."), h = v.shift(), v.sort()), c = h.indexOf(":") < 0 && "on" + h, (e = e[T.expando] ? e : new T.Event(h, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = v.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = t), n = null == n ? [e] : T.makeArray(n, [e]), d = T.event.special[h] || {}, o || !d.trigger || !1 !== d.trigger.apply(t, n))) {
                                ...
                                for (r = 0;
                                    (a = f[r++]) && !e.isPropagationStopped();) p = a, e.type = r > 1 ? l : d.bindType || h, (u = (se.get(a, "events") || Object.create(null))[e.type] && se.get(a, "handle")) && u.apply(a, n), (u = c && a[c]) && u.apply && re(a) && (e.result = u.apply(a, n), !1 === e.result && e.preventDefault());
                    ...
                    var Pn = /%20/g,
                        ...
                        Un = {},
                        Xn = "*/".concat("*"),
                        Yn = x.createElement("a");

                    function Zn(e) {
                        return function(n, t) {
                            "string" != typeof n && (t = n, n = "*");
                            var i, o = 0,
                                r = n.toLowerCase().match(U) || [];
                            if (m(t))
                                for (; i = r[o++];) "+" === i[0] ? (i = i.slice(1) || "*", (e[i] = e[i] || []).unshift(t)) : (e[i] = e[i] || []).push(t)
                        }
                    }
                    ...
                    Yn.href = Mn.href, T.extend({
                        ...
                        ajax: function(e, n) {
                            ...
                            var t, o, r, a, s, l, c, u, d, p, g = T.ajaxSetup({}, n),
                                f = g.context || g,
                                h = g.context && (f.nodeType || f.jquery) ? T(f) : T.event,
                                v = T.Deferred(),
                                ...
                                C = {
                                    ...
                                    getResponseHeader: function(e) {
                                        ...
                                        if (c) {
                                            if (!a)
                                                for (a = {}; n = _n.exec(r);) a[n[1].toLowerCase() + " "] = (a[n[1].toLowerCase() + " "] || []).concat(n[2]);
                                            n = a[e.toLowerCase() + " "]
                                        }
                            ...
                            if (v.promise(C), g.url = ((e || g.url || Mn.href) + "").replace(Gn, Mn.protocol + "//"), g.type = n.method || n.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(U) || [""], null == g.crossDomain) {
                                l = x.createElement("a");
                                try {
                            ...
                            if (k = "abort", m.add(g.complete), C.done(g.success), C.fail(g.error), t = Qn(Un, g, n, C)) {
                                if (C.readyState = 1, u && h.trigger("ajaxSend", [C, g]), c) return C;
                            ...
                            function S(e, n, a, l) {
                                ...
                                c || (c = !0, s && i.clearTimeout(s), t = void 0, r = l || "", C.readyState = e > 0 ? 4 : 0, d = e >= 200 && e < 300 || 304 === e, a && (w = function(e, n, t) {
                                    ...
                                    for (r = u.shift(); r;)
                                        if (e.responseFields[r] && (t[e.responseFields[r]] = n), !l && i && e.dataFilter && (n = e.dataFilter(n, e.dataType)), l = r, r = u.shift())
                                            if ("*" === r) r = l;
                                            else if ("*" !== l && l !== r) {
                                        if (!(a = c[l + " " + r] || c["* " + r]))
                                            for (o in c)
                    ...
                    T.ajaxSetup({
                        ...
                        return "string" != typeof e ? [] : ("boolean" == typeof n && (t = n, n = !1), n || (v.createHTMLDocument ? ((i = (n = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href, n.head.appendChild(i)) : n = x), r = !t && [], (o = P.exec(e)) ? [n.createElement(o[1])] : (o = Ie([e], n, r), r && r.length && T(r).remove(), T.merge([], o.childNodes)));
                        var i, o, r
    ...
    return e = i(692), $3Dmol.UI = function() {
        var n = {
                resn: {
                    type: "string",
                    valid: !0,
        ...
        return function(i, a, s) {
            a = a || {};
            var l = new $3Dmol.UI.Icons,
                c = null,
                u = e(s[0]),
                d = a.height;

            function p() {
                var n = this.ui = e("<div></div>");
                n.css({
                    position: "relative",
                    "min-width": "150px"
                });
                var t = new b(l.molecule, 20, {
                    tooltip: "Toggle Model Selection Bar"
                });
                n.append(t.ui), t.ui.css({
                ...
                var u = e("<div></div>");
                r.append(u);
                var d = "pdb,mmtf,cid".split(","),
                    p = this.list = new $3Dmol.UI.Form.ListInput(o.urlType, d);
                ...
                f.ui.css({
                    margin: "0px"
                }), u.append(f.ui), this.updateInputLength = function() {}, t.ui.on("click", () => {
                    r.toggle()
                }), f.ui.on("click", function() {
                    var e = p.validate();
                    g.validate() && e && i.addModel(o)
            ...
            function g(n, o = "left") {
                ...
                function w() {
                    ...
                    d.ui.on("click", function() {
                        i.removeSelection(o), n.detach()
                    }), p.ui.on("click", function() {
                        v.toggle()
                    });
                    var y = !1;
                    g.ui.on("click", () => {
                        i.toggleHide(o), y ? (y = !1, g.setSVG(l.visible)) : (y = !0, g.setSVG(l.invisible))
                    });
                    var x = new f;
                    ...
                    function E(e) {
                        r.show(), u.editMode = !0, o = this.id = e, s.text("Sel#" + e), n.attr("data-id", e), v.hide(), x.setSid(e), x.ui.show()
                    }

                    function M(e = null) {
                        if (S.validate()) {
                            S.getValue();
                            var n = i.checkAtoms(C.value);
                            0 == Object.keys(C.value).length ? A.error("Please enter some input") : n ? (E(i.addSelection(C.value, e)), null == e && (c = !1)) : A.error("No atom selected")
                        } else A.error("Invalid Input")
                    }
                    v.append(A.ui), v.append(T), n.append(m), k.update = function() {
                        S.ui.toggle()
                    }, D.ui.on("click", () => {
                        0 == u.editMode ? w.value ? (E(i.addSelection({})), c = !1) : M() : w.value ? (i.addSelection({}, o), E(o)) : M(o)
                    }), L.ui.on("click", () => {
                        u.editMode ? v.hide() : (n.detach(), c = !1)
                    }), n.on("keyup", e => {
            ...
            function f(n, t = "left") {
                ...
                function v(n) {
                    ...
                    u.append(d.ui), u.append(p.ui), u.append(g.ui);
                    var f = e("<div></div>");
                    t.append(f), d.ui.on("click", {
                        parent: this,
                        stid: r
                    }, function() {
                        i.removeStyle(n, r), t.detach()
                    }), p.ui.on("click", function() {
                        f.toggle()
                    });
                    var v = !1;
                    g.ui.on("click", () => {
                        i.toggleHideStyle(n, r), v ? (v = !1, g.setSVG(l.visible)) : (v = !0, g.setSVG(l.invisible))
                    });
                    ...
                    function T(e = null) {
                        y.validate() ? (y.getValue(), 0 == Object.keys(m.value).length ? C.error("Please enter some value") : (S(i.addStyle(m.value, n, e)), null == e && (c = !1))) : C.error("Invalid Input")
                    }
                ...
                d.append(f.ui), p.append(g.ui), d.append(p), "left" == t ? r.css("text-align", "left") : r.css("text-align", "right"), d.css("box-sizing", "border-box"), d.css("padding", "3px"), d.css("background-color", "#a4a4a4"), d.css("border-radius", "4px"), u.css("overflow", "hidden"), s.css("box-sizing", "content-box"), g.ui.on("click", () => {
            ...
            function v() {
                var t = this.ui = e("<div></div>");
                t.css("position", "absolute"), t.css("border-radius", "3px"), t.css("background", "#f1f1f1"), t.css("z-index", 99);
                var o = e("<div></div>");
                o.css("position", "relative"), t.css("opacity", "0.85"), t.append(o), o.css({
                    background: "#f1f1f1",
                    "border-radius": "4px",
                    padding: "4px",
                    width: "140px"
                ...
                function p(n, t) {
                    ...
                    var o = new $3Dmol.UI.Form.Checkbox(i),
                        r = e("<td></td>");
                    r.append(o.ui);
                    var a = e("<td></td>"),
                        s = e("<td></td>").text(":"),
                        l = e("<td></td>");
                    this.row.append(r, a, s, l), a.text(n), "number" == typeof t ? l.text(t.toFixed(2)) : l.text(t.replace(/\^/g, ""))
                }
                o.append(d);
                var g = e("<div></div>");
                o.append(g);
                ...
                o.append(x.ui), t.hide(), this.hidden = !0, this.atom = null, a.on("click", {
                    atom: this.atom
                }, function() {
                    i.removeAtomLabel(a.atom)
                }), this.show = function(n, o, r, s) {
                    s ? (a.show(), a.atom = r) : (a.hide(), a.atom = null), x.ui.hide(), v.hide(), 0 == i.getSelectionList().length ? x.message("Please create selections before adding label") : v.show(), k(), y(t, n, o), t.show(), this.hidden = !1, r ? (function(n) {
                        d.empty(), u = [];
                        var t = e("<table></table>");
                        c.forEach(e => {
                            var i = new p(e, n[e]);
                            t.append(i.row), u.push(i)
                        }), d.append(t);
                        var o = e("<div><div>"),
                            r = e("<div><div>");
                        r.text("Style"), r.css({
                        ...
                        d.append(v.ui), d.append(f), s.ui.on("click", () => {
                            var e = w(),
                                t = a.validate();
                            null != e ? t ? (i.addAtomLabel(e, n, a.getValue().value), i.exitContextMenu(!1)) : v.error("Select style for label") : v.error("No value selected for label")
                        }), g.ui.on("click", () => {
                            i.exitContextMenu()
                        })
                    ...
                    if (e) {
                        var n = w();
                        null != n && i.addAtomLabel(n, this.atom)
                    }
                    t.hide(), this.hidden = !0, k()
                }, v.on("click", function() {
                    var n, t = function() {
                        var n = e("<div></div>"),
                            t = {
                        ...
                        o.append(r.ui, a.ui, s.ui), r.ui.hide(), n.append(o);
                        var c = e("<div></div>"),
                            u = e("<div></div>").text("Label Text"),
                            d = new $3Dmol.UI.Form.Input(t.text);
                        c.append(u, d.ui), d.setWidth(126), n.append(c);
                        var p = e("<div></div>"),
                            g = e("<div></div>").text("Label Style"),
                            f = new $3Dmol.UI.Form.ListInput(t.style, Object.keys($3Dmol.labelStyles));
                        f.setValue("milk"), p.append(g, f.ui), n.append(p);
                        var h = i.getSelectionList(),
                            v = e("<div></div>"),
                            m = e("<div></div>").text("Label Selection"),
                            y = new $3Dmol.UI.Form.ListInput(t.sel, h);
                        return v.append(m, y.ui), n.append(v), n.css({
                            padding: "2px"
                        }), a.ui.on("click", () => {
                            var e = !0;
                            f.validate() || (e = !1), d.validate() || (e = !1), y.validate() || (e = !1), e && i.addLabel(t)
                        }), s.ui.on("click", () => {
                            i.exitContextMenu()
                        }), r.ui.on("click", () => {
                            i.removeLabel()
                    ...
                    n = t, m.children().detach(), m.append(n.boundingBox), m.show()
                })
            }
            ...
            function m() {
                ...
                function f() {
                    ...
                    var y = new $3Dmol.UI.Form.ListInput(n.surfaceType, Object.keys($3Dmol.SurfaceType));
                    v.append(m, y.ui), f.append(v), y.setValue(Object.keys($3Dmol.SurfaceType)[0]);
                    var x = e("<div></div>"),
                        w = e("<div></div>"),
                        k = new $3Dmol.UI.Form(r, n.surfaceStyle);
                    x.append(w, k.ui), f.append(x);
                    var C = e("<div></div>"),
                        S = e("<div></div>");
                    S.text("Surface Atoms"), S.css(p);
                    var T = "Atoms in the selections will be used to generate the surface",
                        D = "All the atoms will be used to generate the surface",
                        L = new $3Dmol.UI.Form.ListInput(n.surfaceOf, ["self", "all"]),
                        A = e("<div></div>");
                    A.css({
                    ...
                    var E = ["all"].concat(i.getSelectionList()),
                        M = e("<div></div>"),
                        j = e("<div></div>");
                    j.text("Show Atoms"), j.css(p);
                    var I = new $3Dmol.UI.Form.ListInput(n.surfaceFor, E);
                    ...
                    O.ui.on("click", {}, function() {
                        if (I.getValue(), L.getValue(), y.getValue(), k.getValue(), H())
                            if (!1 === c.editMode) {
                                var e = i.addSurface(n);
                                n.id = e, B(e), g.push(this), t = !1
                            } else k.getValue(), n.id = o.data("surf-id"), i.editSurface(n), f.hide();
                        else z.error("Invalid Input")
                    }), V.ui.on("click", {}, function() {
                        0 == c.editMode ? (o.detach(), o.remove(), t = !1) : (f.hide(), c.editMode = !1)
                    }), o.on("keyup", e => {
                ...
                p.ui.on("click", {
                    ...
                    if (t) c.warning("Please complete the previous form first");
                    else {
                        var e = new f;
                        s.append(e.ui), t = !0
                    }
            ...
            function b(n, t, i) {
                var o = (i = i || {}).bfr * t || t / 4,
                    r = i.backgroundColor || "rgb(177, 194, 203)",
                    a = i.color || "black",
                    s = i.hoverable || "true",
                    l = i.tooltip || null,
                    c = this.ui = e("<div></div>"),
                    u = e("<div></div>");
                c.append(u), c.css("box-sizing", "border-box"), c.css("display", "inline-block"), c.css("margin", "3px"), c.css("height", t), c.css("width", t), c.css("border-radius", o + "px"), c.css("color", a), c.css("background", r), u.css("display", "flex"), u.css("justify-content", "center"), u.css("align-items", "center"), u.css("padding", "2px"), this.setSVG = function(n) {
                    u.empty();
                    var t = e(n);
                    u.append(t)
                }, this.setSVG(n), c.css({
            ...
            this.tools = function() {
                ...
                var t = new m;
                u.append(t.ui), x(u, t.ui, "right", "top", 0, e.ui.height() + 5);
                ...
                var e = this.tools.selectionBox,
                    n = this.tools.surfaceMenu,
                    t = this.tools.modelToolBar,
                    i = u.height();
        ...
        $3Dmol.StateManager = function(n, t) {
            ...
            this.addSelection = function(e, n = null) {
                ...
                var r = "all" == e.surfaceFor.value ? {
                        spec: {}
                    } : a[e.surfaceFor.value],
                    l = "self" == e.surfaceOf.value ? r.spec : {};
                ...
                var t = e.surfaceStyle.value || {},
                    i = "all" == e.surfaceFor.value ? {
                        spec: {}
                    } : a[e.surfaceFor.value],
                    o = "self" == e.surfaceOf.value ? i.spec : {};
                ...
                var t = $3Dmol.labelStyles[e.style.value],
                    i = a[e.sel.value],
                    o = l[e.sel.value].length;
            ...
            return n.Color = function(t) {
                ...
                var u = this.checkInput = function() {
                    ...
                    return "number" == o ? function() {
                        ...
                        var e = r.val(),
                            n = e.match(/\./g) || [],
                            t = e.replaceAll(/\./g, "").replaceAll(/[0-9]/g, "");
